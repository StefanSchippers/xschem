...
B 2 1520 -610 2440 -70 {flags=graph
y1=-47
y2=50
divy=4
subdivy=4
...
B 2 960 -890 1094 -803 {flags=image alpha=0.5
...
B 2 1520 -1010 2440 -610 {flags=graph
y1=-0.19
y2=160
divy=4
subdivy=9
...
color="4 7"
node="tcleval(\\"vpp $\{path\}outi - i(v.$\{path\}vu) *\\"
\\"vpp $\{path\}outi - i(v.$\{path\}vu) * integ() time /\\")"}
T {ANALOG AUDIO AMPLIFIER
N-Channel only power stage} 430 -270 0 0 0.5 0.5 {layer=8}
T {Instant power into xm1} 1530 -1050 0 0 0.4 0.4 {layer=4}
T {Average power into xm1} 1980 -1050 0 0 0.4 0.4 {layer=7}
